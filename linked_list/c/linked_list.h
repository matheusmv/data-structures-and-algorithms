...
void linked_list_insert_obj_at(linked_list *list, void *object, int index);
void *linked_list_get_obj_at(linked_list *list, int index);
void linked_list_remove_obj_at(linked_list *list, int index, void *buffer);
