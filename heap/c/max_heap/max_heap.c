...
static void increase_array_length(max_heap *heap)
{
...
static void decrease_array_length(max_heap *heap)
{
        const size_t arr_length = heap->length;
...
static void increase_array_size(max_heap *heap)
{
